...
//    jQuery(window).load(function() {
		jQuery(function() {
			...
			if (!myCamera.hasClass('motopress-camera')) {
				...
				myCamera.camera({
					alignment           : 'centerRight', //topLeft, topCenter, topRight, centerLeft, center, centerRight, bottomLeft, bottomCenter, bottomRight
					...
					height              : '41.62%', //here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'
